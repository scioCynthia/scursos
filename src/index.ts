...
import tiendaCursosRoutes from "./routes/tiendaCursos";
...
router.use('/api', middleware.verifyTokens, cursosRoutes);  

router.use('/api', middleware.verifyTokens, tiendaCursosRoutes);  
